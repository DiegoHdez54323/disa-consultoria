...
export const EnterpriseCtaReact = () => {
  ...
  return (
    <div className="relative mt-12 mb-6 mx-4 md:mx-0 overflow-hidden rounded-4xl border border-emerald-500/20 bg-card/40 backdrop-blur-md group">
      ...
      <div className="relative z-10 p-8 md:p-10 flex flex-col lg:flex-row items-start gap-12">
        ...
        <div className="flex-1 text-left">
          ...
          <h4 className="font-orbitron text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-400 to-cyan-400">Operaciones Críticas</span>
          </h4>
