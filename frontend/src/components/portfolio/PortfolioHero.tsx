      ...
      <div className="relative container mx-auto px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h1 className="font-sora text-5xl lg:text-7xl xl:text-8xl font-bold text-foreground leading-tight">
              Proyectos que
            </h1>
            <div className="relative inline-block mt-2">
              <span className="font-sora text-5xl lg:text-7xl xl:text-8xl font-bold text-gradient-secondary">
                Inspiran
              </span>
              <motion.div
                initial={{ scaleX: 0 }}
          ...
          <motion.p
            ...
            className="font-inter text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto"
          >
            Ideas disruptivas convertidas en soluciones reales. Cada proyecto
            cuenta una historia de innovación.
          </motion.p>
          ...
          >
            {[
              ...
              >
                <div className="font-sora text-4xl lg:text-5xl font-bold text-gradient-primary">
                  {stat.value}
                </div>
